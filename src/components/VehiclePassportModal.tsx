          ...
          <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-850 space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold text-white">{passportData.vin || "VIN-KA32M9988"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Make / Model:</span>
                <span className="font-bold text-slate-200">{passportData.vehicleMake || "TATA"} {passportData.vehicleModel || "Heavy Commercial"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Customer Name:</span>
                <span className="font-bold text-slate-200">{passportData.customerName || "Devanand Logistics"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Customer Dues:</span>
                <span className="font-mono font-bold text-emerald-400">₹0.00 (Clear)</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-850 space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold text-slate-300">{passportData.lastOdometer || 40200} km</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Current Gate Odometer:</span>
                <span className="font-mono font-bold text-white">{passportData.currentOdometer || 45000} km</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Previous Visits:</span>
                <span className="font-bold text-blue-400">{passportData.previousVisitCount || 3} recorded visits</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-850 space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-emerald-400">{passportData.warrantyStatus || "ACTIVE COVERAGE"}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">FSV Eligibility:</span>
                <span className="font-bold text-blue-400">Eligible (2nd Free Service)</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-850 space-y-2">
            ...
            <div className="space-y-1 text-slate-300">
              <div className="flex items-center gap-1.5 text-amber-400">
                ...
                <span className="font-bold">FSB-2026-EV-COOLANT-CHECK</span>
              </div>
              <p className="text-[10px] text-slate-400">Mandatory coolant hose inspection for 2025/2026 EV models.</p>
            </div>
          </div>
        </div>
