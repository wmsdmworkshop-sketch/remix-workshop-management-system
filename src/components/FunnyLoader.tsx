...
const FUNNY_MESSAGES = [
  "Mechanic is hitting the engine block with a spanner...",
  "Calibrating the flux capacitor...",
  "Trying to remember where this extra bolt belongs...",
  "Tightening the horn to make it sound louder...",
  "Asking the supervisor if WD-40 fixes engine fires...",
  "Bribing the grease monkeys with bananas...",
  "Polishing the exhaust pipes for aerodynamic whistling...",
  "Checking if the oil tank accepts mustard...",
  "Engaging the hyperdrive grease system...",
  "Tapping the dashboard until the error lights go away..."
];

export default function FunnyLoader({ message }: { message?: string }) {
  ...
  useEffect(() => {
    if (message) {
      ...
      setLoadingMessage(FUNNY_MESSAGES[idx]);
    }
  }, [message]);
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center space-y-4 animate-fade-in">
      <div className="relative">
        <svg width="120" height="120" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
          <style>{`
            .spanner {
      ...
      <p className="text-xs font-bold text-slate-500 uppercase tracking-widest animate-pulse max-w-xs mx-auto">
        {loadingMessage}
      </p>
    </div>
  );
